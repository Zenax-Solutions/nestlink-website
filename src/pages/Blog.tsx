  ...
  return (
    <div className="min-h-screen bg-[#f2f2f2] pt-28 pb-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-12">
        ...
        {loading ? (
          <p className="mt-20 text-center font-sans text-sm text-black/40">Loading posts...</p>
        ) : posts.length === 0 ? (
          <p className="mt-20 text-center font-sans text-sm text-black/40">No blog posts found.</p>
        ) : (
