              ...
              <div className="rounded-3xl border border-white/10 bg-white/[0.02] p-8 md:p-10">
                ...
                <ul className="mt-8 space-y-6">
                  <li className="flex items-start gap-4">
                    ...
                    <div>
                      <span className="font-sans text-xs uppercase tracking-wider text-white/50">
                        Phone / WhatsApp
                      </span>
                      <a
                        href="tel:+971504429734"
                        className="mt-1 block font-sans text-base font-semibold text-white transition-colors hover:text-[#0000FF]"
                      >
                        +971 50 442 9734
                      </a>
                    </div>
                  ...
                  <li className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <span className="mt-1 block font-sans text-base font-semibold text-white">
                        Dubai, UAE
                      </span>
                    </div>
                  </li>
                  ...
                  <form onSubmit={handleSubmit} className="mt-8 space-y-5">
                    <div className="grid gap-5 md:grid-cols-2">
                      <div>
                        <label
                          htmlFor="name"
                          className="mb-2 block font-sans text-xs font-semibold uppercase tracking-wider text-white/60"
                        >
                          Full Name
                        </label>
                        <input
                          ...
                          className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 font-sans text-sm text-white placeholder-white/30 outline-none transition-colors focus:border-[#0000FF]/50"
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 font-sans text-sm text-white outline-none transition-colors focus:border-[#0000FF]/50"
                      >
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full resize-none rounded-xl border border-white/10 bg-white/5 px-4 py-3 font-sans text-sm text-white placeholder-white/30 outline-none transition-colors focus:border-[#0000FF]/50"
                    ...
                    <button
                      type="submit"
                      className="group inline-flex w-full items-center justify-center gap-3 rounded-full bg-[#0000FF] px-8 py-4 font-sans text-sm font-bold uppercase text-white transition-transform duration-200 hover:scale-[1.02] md:w-auto"
                    >
                      Send Message
                      <Send
                        size={16}
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-12">
          <AnimatedSection className="overflow-hidden rounded-3xl border border-white/10">
            <div className="flex h-[320px] flex-col items-center justify-center bg-white/[0.02] md:h-[400px]">
              ...
              <p className="mt-2 max-w-md text-center font-sans text-sm text-white/60">
